...
![PDF Chapter Splitter running in the browser](.github/assets/chapter-splitter-web.png)
...
Download the archive for macOS (Apple silicon), Windows x86-64, or Linux x86-64 from the
